...
$.richFilemanagerPlugin = function(element, pluginOptions)
{
		...
		return $.when(loadConfigFile('default'), loadConfigFile('user')).done(function(confd, confu) {
			...
			if(config.api.connectorUrl) {
				...
				apiConnector = connectorUrl + langConnector;
                        ...
                        try{
                            if(fm.settings.config.api.connectorUrl !== undefined && fm.settings.config.api.connectorUrl !== null){
	...
	var includeAssets = function() {
		...
		var theme = config.options.theme;
                try{  
                    if(fm.settings.config.options.theme !== undefined && fm.settings.config.options.theme !== null){
                ...
                loadCSS('/themes/' + theme + '/styles/theme.css');
